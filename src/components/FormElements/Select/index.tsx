...
export function Select(props: SelectOptions) {
  ...
  const evaluatedItems = () =>
    items.toArray() as unknown as SelectOptionProps[];
  ...
  const [query, setQuery] = createSignal(
    props.filter && props.multi ? '' : props.defaultLabel
  );
    ...
    <div classList={classList()} style={props.style} ref={wrap}>
                    ...
                    {(props: any): JSXElement => {
                      ...
                      if (item.emptyOption) {
                        return (
                          <EmptyOption
                            visible
                            data={{ label: item[textField], value: '' }}
                            checked={value() === ''}
                            onClick={onClear}
                          />
                        );
      ...
      >
        ...
        <Value
          ...
          size={props.size}
          icon={<Icon name="chevron-down" class="cm-select-cert" />}
